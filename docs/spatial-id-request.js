(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var fetch = origFetch__default["default"].bind(undefined);
    ...
    var requestToGeoJSON = function (source, id) { return __awaiter(void 0, void 0, void 0, function () {
        var tilejson, response_1, _a, tiles, rawMinzoom, maxzoom, minzoom, requestZoom, requestTile, tileUrl, response, data, tile, out, zfxyGeom, layerName, layer, i, feature;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    zfxyGeom = id.toGeoJSON();
                    for (layerName in tile.layers) {
                        layer = tile.layers[layerName];
                        for (i = 0; i < layer.length; i++) {
                            feature = layer.feature(i).toGeoJSON(requestTile.zfxy.x, requestTile.zfxy.y, requestTile.zfxy.z);
